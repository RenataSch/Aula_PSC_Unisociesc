...
import projetoPáscoa.Exponenciacao;
import projetoPáscoa.Fatorial;
...
public class Calculadora {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite a operacao(1-adicao, 2-subtracao, 3-multiplicacao, 4-divisao, 5-exponenciacao, 6-fatorial:");
		...
		case 5 : System.out.println("Exponenciacao=" + Math.pow(valor1, valor2)); break;
        case 6 : int fat = 1; for (int i = 1; i <= valor1; i++) { fat *= i;}
            System.out.println("Fatorial=" + fat); break;
		...
		case 5 : operacaoNivel2 = new Exponenciacao();
				operacaoNivel2.setNumero1(valor1);
				operacaoNivel2.setNumero2(valor2);
				System.out.println("Exponenciacao="+operacaoNivel2.calcula());
				break;
		...
		default : operacaoNivel2 = null;
				...
				System.out.println("Exponenciacao="+operacaoNivel3.calcula(valor1, valor2));
				break;
